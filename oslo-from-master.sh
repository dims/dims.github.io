pip install -q -U \
    -e git+https://github.com/openstack/oslo.cache.git#egg=oslo.cache
pip install -q -U \
...
pip install -q -U \
    -e git+https://github.com/openstack/oslo.policy.git#egg=oslo.policy
pip install -q -U \
    -e git+https://github.com/openstack/oslo.privsep.git#egg=oslo.privsep
pip install -q -U \
    -e git+https://github.com/openstack/oslo.reports.git#egg=oslo.reports
pip install -q -U \
